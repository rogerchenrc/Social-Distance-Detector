...
def detection(inputs, output, display=1):
    ...
    print("Processing Finished: open {}".format(output))
    writer.release()
    vs.release()
    cv2.destroyAllWindows()

# input = "input/test2_oxford.mp4"
# output = "output/testing1.avi"
# display = 1
#
# detection(input, output, display)